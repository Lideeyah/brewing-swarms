            ...
            {[
              ...
              >
                <div className="flex items-baseline gap-1.5">
                  <span className="font-mono text-3xl font-bold text-white leading-none">{s.v}</span>
                  {'suffix' in s && s.v !== '—' && (
                    <span className="font-mono text-xs" style={{ color: 'rgba(255,255,255,0.4)' }}>{s.suffix}</span>
                  )}
                </div>
                <span className="font-mono text-[11px] tracking-wide" style={{ color: 'rgba(255,255,255,0.45)' }}>{s.l}</span>
              </div>
            ))}
          </div>
        </div>
